...
## GlmOcrConfig[[transformers.GlmOcrConfig]]

#### transformers.GlmOcrConfig[[transformers.GlmOcrConfig]]

[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/glm_ocr/configuration_glm_ocr.py#L231)

This is the configuration class to store the configuration of a [GlmOcrModel](/docs/transformers/main/en/model_doc/glm_ocr#transformers.GlmOcrModel). It is used to instantiate a  
...
text_config (`Union[PreTrainedConfig, dict]`, *optional*, defaults to `GlmOcrTextConfig`) : The config object or dictionary of the text backbone.

vision_config (`Union[PreTrainedConfig, dict]`,  *optional*, defaults to `GlmOcrVisionConfig`) : The config object or dictionary of the vision backbone.

image_token_id (`int`, *optional*, defaults to 59280) : The image token index to encode the image prompt.

video_token_id (`int`, *optional*, defaults to 59281) : The video token index to encode the image prompt.
...
## GlmOcrVisionConfig[[transformers.GlmOcrVisionConfig]]

#### transformers.GlmOcrVisionConfig[[transformers.GlmOcrVisionConfig]]

[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/glm_ocr/configuration_glm_ocr.py#L25)

This is the configuration class to store the configuration of a [GlmOcrVisionConfig](/docs/transformers/main/en/model_doc/glm_ocr#transformers.GlmOcrVisionConfig). It is used to instantiate a
GLM-OCR model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of
GLM-OCR [zai-org/GLM-OCR](https://huggingface.co/zai-org/GLM-OCR).
...
hidden_act (`str` or `function`, *optional*, defaults to `"silu"`) : The non-linear activation function (function or string) in the encoder and pooler. If string, `"silu"`, `"relu"`, `"selu"` and `"gelu_new"` are supported.
...
## GlmOcrTextConfig[[transformers.GlmOcrTextConfig]]

#### transformers.GlmOcrTextConfig[[transformers.GlmOcrTextConfig]]

[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/glm_ocr/configuration_glm_ocr.py#L110)

This is the configuration class to store the configuration of a [GlmOcrTextConfig](/docs/transformers/main/en/model_doc/glm_ocr#transformers.GlmOcrTextConfig). It is used to instantiate a
GLM-OCR model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of
GLM-OCR [zai-org/GLM-OCR](https://huggingface.co/zai-org/GLM-OCR).
...
vocab_size (`int`, *optional*, defaults to 59392) : Vocabulary size of the GlmOcr model. Defines the number of different tokens that can be represented by the `inputs_ids` passed when calling [GlmOcrModel](/docs/transformers/main/en/model_doc/glm_ocr#transformers.GlmOcrModel)
...
num_hidden_layers (`int`, *optional*, defaults to 16) : Number of hidden layers in the Transformer encoder.
...
## GlmOcrVisionModel[[transformers.GlmOcrVisionModel]]

#### transformers.GlmOcrVisionModel[[transformers.GlmOcrVisionModel]]

[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/glm_ocr/modeling_glm_ocr.py#L548)

forwardtransformers.GlmOcrVisionModel.forward[https://github.com/huggingface/transformers/blob/main/src/transformers/models/glm_ocr/modeling_glm_ocr.py#L612[{"name](https://github.com/huggingface/transformers/blob/main/src/transformers/models/glm_ocr/modeling_glm_ocr.py#L612[{"name)": "hidden_states", "val": ": Tensor"}, {"name": "grid_thw", "val": ": Tensor"}, {"name": "**kwargs", "val": ""}]- **hidden_states** (`torch.Tensor` of shape `(seq_len, hidden_size)`) --
  The final hidden states of the model.

- **grid_thw** (`torch.Tensor` of shape `(num_images_or_videos, 3)`) --
The temporal, height and width of feature shape of each image in LLM.0`torch.Tensor`hidden_states.
The [GlmOcrVisionModel](/docs/transformers/main/en/model_doc/glm_ocr#transformers.GlmOcrVisionModel) forward method, overrides the `__call_`_ special method.
...
## GlmOcrTextModel[[transformers.GlmOcrTextModel]]

#### transformers.GlmOcrTextModel[[transformers.GlmOcrTextModel]]

[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/glm_ocr/modeling_glm_ocr.py#L740)
...
The [GlmOcrTextModel](/docs/transformers/main/en/model_doc/glm_ocr#transformers.GlmOcrTextModel) forward method, overrides the `__call_`_ special method.
...
config ([GlmOcrTextConfig](/docs/transformers/main/en/model_doc/glm_ocr#transformers.GlmOcrTextConfig)) : Model configuration class with all the parameters of the model. Initializing with a config file does not load the weights associated with the model, only the configuration. Check out the [from_pretrained()](/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained) method to load the model weights.
...
## GlmOcrModel[[transformers.GlmOcrModel]]

#### transformers.GlmOcrModel[[transformers.GlmOcrModel]]

[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/glm_ocr/modeling_glm_ocr.py#L848)
...
`image_processor_class`. See `image_processor_class.__call_`_ for details (`processor_class` uses
...
`video_processor_class`. See `video_processor_class.__call_`_ for details (`processor_class` uses
...
Indices depicting the position of the input sequence tokens in the sequence. Contrarily to `position_ids`,
this tensor is not affected by padding. It is used to update the cache in the correct position and to infer
the complete sequence length.0`transformers.models.glm_ocr.modeling_glm_ocr.GlmOcrModelOutputWithPast` or `tuple(torch.FloatTensor)`A `transformers.models.glm_ocr.modeling_glm_ocr.GlmOcrModelOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration (`None`) and inputs.
...
The [GlmOcrModel](/docs/transformers/main/en/model_doc/glm_ocr#transformers.GlmOcrModel) forward method, overrides the `__call_`_ special method.
...
#### get_image_features[[transformers.GlmOcrModel.get_image_features]]

[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/glm_ocr/modeling_glm_ocr.py#L1050)
...
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([GlmOcrConfig](/docs/transformers/main/en/model_doc/glm_ocr#transformers.GlmOcrConfig)) and inputs.
...
#### get_placeholder_mask[[transformers.GlmOcrModel.get_placeholder_mask]]

[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/glm_ocr/modeling_glm_ocr.py#L1072)

Obtains multimodal placeholder mask from `input_ids` or `inputs_embeds`, and checks that the placeholder token count is
equal to the length of multimodal features. If the lengths are different, an error is raised.

#### get_rope_index[[transformers.GlmOcrModel.get_rope_index]]

[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/glm_ocr/modeling_glm_ocr.py#L870)
...
#### get_video_features[[transformers.GlmOcrModel.get_video_features]]

[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/glm_ocr/modeling_glm_ocr.py#L1019)
...
## GlmOcrForConditionalGeneration[[transformers.GlmOcrForConditionalGeneration]]

#### transformers.GlmOcrForConditionalGeneration[[transformers.GlmOcrForConditionalGeneration]]

[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/glm_ocr/modeling_glm_ocr.py#L1249)

forwardtransformers.GlmOcrForConditionalGeneration.forward[https://github.com/huggingface/transformers/blob/main/src/transformers/models/glm_ocr/modeling_glm_ocr.py#L1300[{"name](https://github.com/huggingface/transformers/blob/main/src/transformers/models/glm_ocr/modeling_glm_ocr.py#L1300[{"name)": "input_ids", "val": ": torch.LongTensor | None = None"}, {"name": "attention_mask", "val": ": torch.Tensor | None = None"}, {"name": "position_ids", "val": ": torch.LongTensor | None = None"}, {"name": "past_key_values", "val": ": transformers.cache_utils.Cache | None = None"}, {"name": "inputs_embeds", "val": ": torch.FloatTensor | None = None"}, {"name": "labels", "val": ": torch.LongTensor | None = None"}, {"name": "pixel_values", "val": ": torch.Tensor | None = None"}, {"name": "pixel_values_videos", "val": ": torch.FloatTensor | None = None"}, {"name": "image_grid_thw", "val": ": torch.LongTensor | None = None"}, {"name": "video_grid_thw", "val": ": torch.LongTensor | None = None"}, {"name": "cache_position", "val": ": torch.LongTensor | None = None"}, {"name": "logits_to_keep", "val": ": int | torch.Tensor = 0"}, {"name": "**kwargs", "val": ": typing_extensions.Unpack[transformers.utils.generic.TransformersKwargs]"}]- **input_ids** (`torch.LongTensor` of shape `(batch_size, sequence_length)`, *optional*) --
  Indices of input sequence tokens in the vocabulary. Padding will be ignored by default.
...
This is useful when using packed tensor format (single dimension for batch and sequence length).0`transformers.models.glm_ocr.modeling_glm_ocr.GlmOcrCausalLMOutputWithPast` or `tuple(torch.FloatTensor)`A `transformers.models.glm_ocr.modeling_glm_ocr.GlmOcrCausalLMOutputWithPast` or a tuple of
`torch.FloatTensor` (if `return_dict=False` is passed or when `config.return_dict=False`) comprising various
elements depending on the configuration ([GlmOcrConfig](/docs/transformers/main/en/model_doc/glm_ocr#transformers.GlmOcrConfig)) and inputs.
...
- **attentions** (`tuple[torch.FloatTensor] | None.attentions`, returned when `output_attentions=True` is passed or when `config.output_attentions=True`) -- Tuple of `torch.FloatTensor` (one for each layer) of shape `(batch_size, num_heads, sequence_length, sequence_length)`.
  ...
  heads.
- **rope_deltas** (`torch.LongTensor` of shape `(batch_size, )`, *optional*) -- The rope index difference between sequence length and multimodal rope.
The [GlmOcrForConditionalGeneration](/docs/transformers/main/en/model_doc/glm_ocr#transformers.GlmOcrForConditionalGeneration) forward method, overrides the `__call_`_ special method.
...
pixel_values (`torch.Tensor` of shape `(batch_size, num_channels, image_size, image_size)`, *optional*) : The tensors corresponding to the input images. Pixel values can be obtained using `image_processor_class`. See `image_processor_class.__call_`_ for details (`processor_class` uses `image_processor_class` for processing images).

pixel_values_videos (`torch.FloatTensor` of shape `(batch_size, num_frames, num_channels, frame_size, frame_size)`, *optional*) : The tensors corresponding to the input video. Pixel values for videos can be obtained using `video_processor_class`. See `video_processor_class.__call_`_ for details (`processor_class` uses `video_processor_class` for processing videos).
...
#### get_image_features[[transformers.GlmOcrForConditionalGeneration.get_image_features]]

[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/glm_ocr/modeling_glm_ocr.py#L1285)
...
#### get_video_features[[transformers.GlmOcrForConditionalGeneration.get_video_features]]

[Source](https://github.com/huggingface/transformers/blob/main/src/transformers/models/glm_ocr/modeling_glm_ocr.py#L1268)
